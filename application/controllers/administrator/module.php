...
class Module extends SB_Controller {
    ...
    //    redirect('dashboard', 301);
        $this->load->model('administrator/modulemodel');
    ...
    public function index() {
        ...
        $this->data['content'] = $this->load->view('administrator/module/index', $this->data, true);
    ...
    function create() {
        ...
        $this->data['content'] = $this->load->view('administrator/module/create', $this->data, true);
        $this->load->view('layouts/main', $this->data);
    }
        ...
        if ($this->form_validation->run()) {
            ...
            if ($this->input->post('creation') == 'manual') {
                if ($where == "") {
                    ...
                    redirect('administrator/module/create', 301);
                }
    ...
    function config($id) {
        ...
        $this->data['content'] = $this->load->view('administrator/module/config', $this->data, true);
        $this->load->view('layouts/main', $this->data);
    }
    ...
    function saveconfig($id) {
        ...
        if ($this->form_validation->run()) {
            ...
            redirect('administrator/module/config/' . $this->input->post('module_name', true));
        } else {
    ...
    function sql($id) {
        ...
        $this->data['content'] = $this->load->view('administrator/module/sql', $this->data, true);
        $this->load->view('layouts/main', $this->data);
    }
    ...
    function saveSql($id) {
        ...
        redirect('administrator/module/sql/' . $row->module_name);
    }
    ...
    function table($id) {
        ...
        $this->data['module'] = $this->module;
        $this->data['module_name'] = $row->module_name;
        $this->data['content'] = $this->load->view('administrator/module/table', $this->data, true);
        $this->load->view('layouts/main', $this->data);
    }
    ...
    public function saveTable() {
        ...
        redirect('administrator/module/table/' . $row->module_name, 301);
    }
    ...
    function form($id) {
        ...
        $this->data['module'] = $this->module;
        $this->data['module_name'] = $row->module_name;
        $this->data['content'] = $this->load->view('administrator/module/form', $this->data, true);
        $this->load->view('layouts/main', $this->data);
    }
    ...
    function saveForm() {
        ...
        redirect('administrator/module/form/' . $row->module_name, 301);
    }
    ...
    function formdesign($id) {
        ...
        if ($this->input->get('block') != '')
            $this->data['form_column'] = $this->input->get('block');
        ...
        $this->data['module_name'] = $row->module_name;
        $this->data['content'] = $this->load->view('administrator/module/formdesign', $this->data, true);
        $this->load->view('layouts/main', $this->data);
    }
    ...
    function saveFormdesign() {
        ...
        $this->session->set_flashdata('message', SiteHelpers::alert('success', 'Module Forms Has Been Saved Successfull'));
        redirect('administrator/module/formdesign/' . $row->module_name, 301);
    }
    ...
    function editform($id) {
        ...
        $this->load->view('administrator/module/editform', $this->data);
    }
    ...
    function permission($id) {
        ...
        $this->data['content'] = $this->load->view('administrator/module/permission', $this->data, true);
        $this->load->view('layouts/main', $this->data);
    }
    ...
    function savePermission() {
        ...
        redirect('administrator/module/permission/' . $row->module_name, 301);
    }
    ...
    function conn($id) {
        ...
        $this->load->view('administrator/module/conn', $this->data);
    }
    ...
    function build($id) {
        ...
        $this->load->view('administrator/module/build', $this->data);
    }
    ...
    function dobuild($id) {
        ...
        //return redirect('')
        $url = 'administrator/module/rebuild/' . $id . "?rebuild=y&c={$c}&m={$m}&g={$g}&f={$f}&v={$v}";
    ...
    function rebuild($id = 0) {
        ...
        if ($row->module_db_key == '') {
            // No CRUD 
            $controller = file_get_contents('application/views/administrator/module/template/controller_view.tpl');
            $grid = file_get_contents('application/views/administrator/module/template/index_view.tpl');
        } else {
            $controller = file_get_contents('application/views/administrator/module/template/controller.tpl');
            $grid = file_get_contents('application/views/administrator/module/template/index.tpl');
        }

        $view = file_get_contents('application/views/administrator/module/template/view.tpl');
        $form = file_get_contents('application/views/administrator/module/template/form.tpl');
        $model = file_get_contents('application/views/administrator/module/template/model.tpl');
        ...
        if (!is_dir("application/views/administrator/{$class}")) {
            mkdir("application/views/administrator/{$class}", 0777);
        }
        ...
        if ($this->input->get('rebuild') != '') {
            ...
            if ($this->input->get('c') == 'y') {
                file_put_contents("application/controllers/administrator/{$class}.php", $build_controller);
            }
            ...
            if ($this->input->get('g') == 'y') {
                file_put_contents("application/views/administrator/{$class}/index.php", $build_grid);
            }
            if ($row->module_db_key != '') {
                if ($this->input->get('f') == 'y') {
                    file_put_contents("application/views/administrator/{$class}/form.php", $build_form);
                }
                if ($this->input->get('v') == 'y') {
                    file_put_contents("application/views/administrator/{$class}/view.php", $build_view);
                }
            }
        } else {
    ...
    function destroy($id = null) {
        ...
        if ($row->module_type != 'core') {
            ...
            if ($class != '') {
                ...
                if (file_exists("application/controllers/administrator/{$class}.php"))
                    unlink("application/controllers/administrator/{$class}.php");

                if (file_exists("application/models/{$class}model.php"))
                    unlink("application/models/{$class}model.php");

                self::removeDir("application/views/administrator/{$path}");
