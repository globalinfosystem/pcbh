...
class Menu extends SB_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model('administrator/menumodel');
    ...
    public function index($id = null) {
        ...
        $this->data['content'] = $this->load->view('administrator/menu/index', $this->data, true);
    ...
    function saveOrder($id = 0) {
        ...
        if ($this->form_validation->run()) {
            ...
            redirect('administrator/menu', 301);
        } else {
            redirect('administrator/menu', 301);
        }
    }
    ...
    function save($id = 0) {
        ...
        if ($this->form_validation->run()) {
            ...
            SiteHelpers::removeCache();
            redirect('administrator/menu?pos=' . $pos);
        } else {
            redirect('administrator/menu?pos=' . $pos);
        }
    }
