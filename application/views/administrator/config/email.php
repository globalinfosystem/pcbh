...
<div class="block-content">
	<ul class="nav nav-tabs" >
		...
		<li  class="active"><a href="<?php echo site_url('administrator/config/email');?>" ><?php echo $this->lang->line('core.t_emailtemplate'); ?> </a></li>
	</ul>	
<div class="tab-content">
	  <div class="tab-pane active use-padding" id="info">	
	 <form class="form-vertical row" action="<?php echo site_url('administrator/config/postEmail');?>" method="post">
