<div class="page-content row">
    ...
    <div class="page-content-wrapper m-t"> 
        <?php $this->load->view('administrator/module/tab', array('active' => 'table')); ?>
        <?php echo $this->session->flashdata('message'); ?>
        <form class="form-vertical" action="<?php echo site_url('administrator/module/savetable/' . $module_name); ?>" method="post">
                                    ...
                                    <tr >
                                        ...
                                        <td >
                                            <span class=" xlick btn-primary btn-xs tips"
                                                  onclick="SximoModal('<?php echo site_url('administrator/module/conn/' . $row->module_id . '?field=' . $rows['field'] . '&alias=' . $rows['alias']); ?>', ' Connect Field : <?php echo $rows['field']; ?> ')"
                                                  >
