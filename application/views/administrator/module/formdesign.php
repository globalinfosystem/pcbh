  ...
  <div class="page-content row ">
    ...
    <div class="page-header">
      ...
      <ul class="breadcrumb">
		...
		<li><a href="<?php echo site_url('administrator/module') ;?>"><?php echo $this->lang->line('core.t_module'); ?> </a></li>
	...
	<ul class="nav nav-tabs" style="margin-bottom:10px;">
		<li ><a href="<?php echo site_url('administrator/module/form/'.$module_name);?>"><?php echo $this->lang->line('core.mod_formtab1'); ?> </a></li> 
		<li class="active" ><a href="<?php echo site_url('administrator/module/formdesign/'.$module_name);?>"><?php echo $this->lang->line('core.mod_formtab2'); ?></a></li> 
	</ul>
...
<div class="sbox">
	...
	<form class="form-vertical" action="<?php echo site_url('administrator/module/saveFormdesign/'.$module_name);?>" method="post" parsley-validate novalidate id="doReorder">	
