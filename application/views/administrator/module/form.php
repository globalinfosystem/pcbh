  ...
  <div class="page-content row">
    ...
    <div class="page-header">
      ...
      <ul class="breadcrumb">
		...
		<li><a href="<?php echo site_url('administrator/module') ;?>"> Module </a></li>
        <li class="active">  Form Grid Editor </li>
      </ul>		  
	  
    </div>
	<div class="page-content-wrapper m-t"> 
	<?php $this->load->view('administrator/module/tab',array('active'=>'form')); ?>
	<?php echo $this->session->flashdata('message');?>

	<ul class="nav nav-tabs" style="margin-bottom:10px;">
		<li class="active" ><a href="<?php echo site_url('administrator/module/form/'.$module_name);?>">Form Configuration </a></li> 
		<li ><a href="<?php echo site_url('administrator/module/formdesign/'.$module_name);?>">Form Layout</a></li> 
	</ul>
  
<div class="sbox">
	<div class="sbox-title"><h5> Form Grid  </h5></div>
	<div class="sbox-content">	
	<form class="form-vertical" action="<?php echo site_url('administrator/module/saveForm/'.$module_name);?>" method="post">
 ...
 <div class="table-responsive">
	...
	?>
		<select name="required[<?php echo $id;?>]" id="required" class="form-control" style="width:150px;" >
			...
			onclick="SximoModal('<?php echo site_url('administrator/module/editform/'.$row->module_id.'?field='.$rows['field'].'&alias='.$rows['alias']) ?>','Edit Field : <?php echo $rows['field'];?>')">
