...
class {controller} extends SB_Controller 
{
	...
	function index() 
	{
		...
		$this->data['content'] = $this->load->view('administrator/{class}/index',$this->data, true );
	...
	function show( $id = null) 
	{
		...
		$this->data['id'] = $id;
		$this->data['content'] =  $this->load->view('administrator/{class}/view', $this->data ,true);	  
		$this->load->view('layouts/main',$this->data);
	}
	...
	function add( $id = null ) 
	{
		...
		$this->data['id'] = $id;
		$this->data['content'] = $this->load->view('administrator/{class}/form',$this->data, true );		
	  	$this->load->view('layouts/main', $this->data );
	...
	function save() {
		...
		if( $this->form_validation->run() )
		{
			...
			{
				redirect( 'administrator/{class}/add/'.$ID,301);
			} else {
				redirect( 'administrator/{class}',301);
			}			
