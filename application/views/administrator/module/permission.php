  <div class="page-content row">
	...
	<?php $this->load->view('administrator/module/tab',array('active'=>'permission')); ?>
	<?php echo $this->session->flashdata('message');?>


 <form class="form-horizontal" action="<?php echo site_url('administrator/module/savePermission/'.$module_name);?>" method="post" parsley-validate novalidate>	
