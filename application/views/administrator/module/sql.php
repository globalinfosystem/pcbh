  ...
  <div class="page-content row">
	...
	<?php $this->load->view('administrator/module/tab',array('active'=>'sql')); ?>
...
<div class="sbox">
 ...
 <div class="sbox-content">
 	<form class="form-vertical" action="<?php echo site_url('administrator/module/savesql/'.$module_name);?>" method="post">
