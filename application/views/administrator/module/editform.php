<script src="<?php echo base_url();?>design/js/simpleclone.js"></script>
...
$(document).ready(function(){
	...
	$("#lookup_table").jCombo("<?php echo site_url('administrator/module/combotable') ;?>" , {
		selected_value : "<?php echo $f['option']['lookup_table'];?>" ,
		initial_text : ' Select Table',
		
	});

	$("#lookup_key").jCombo("<?php echo site_url('administrator/module/combotablefield') ;?>?table=",
...
<form class="form-horizontal" action="<?php echo site_url('administrator/module/savefield/'.$module_name);?>" method="post">
