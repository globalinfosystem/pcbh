 ...
 <div class="page-content-wrapper m-t"> 
	...
	<?php $this->load->view('administrator/module/tab',array('active'=>'config')); ?>
...
<div class="sbox">
	...
	<div class="col-md-8">
	<form class="form-horizontal" action="<?php echo site_url('administrator/module/saveconfig/'.$module_name);?>" method="post">
