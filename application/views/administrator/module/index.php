...
<section >
		...
		<div class="row m-l-none m-r-none m-t  white-bg shortcut " >
			<div class="col-sm-6 col-md-3 b-r  p-sm ">
				...
				<a href="<?php echo site_url('administrator/module/create');?>" class="clear">
	...
	<ul class="nav nav-tabs" style="margin-bottom:10px;">
	  <li <?php if($type =='addon') echo 'class="active"'?>><a href="<?php echo site_url('administrator/module');?>"><?php echo $this->lang->line('core.fr_mymodule'); ?>  </a></li>
	  <li <?php if($type =='core') echo 'class="active"';?>><a href="<?php echo site_url('administrator/module?t=core');?>"><?php echo $this->lang->line('core.tab_core'); ?> </a></li>
	</ul>
			...
			<tr>		
				...
				<i class="fa fa-cog"></i> <span class="caret"></span>
					...
					<ul style="display: none;" class="dropdown-menu icons-right">
						...
						<?php endif;?>
						<li><a href="<?php echo site_url('administrator/module/config/'.$row->module_name);?>"><i class="fa fa-edit"></i><?php echo $this->lang->line('core.fr_editmodule'); ?> </a></li>
						<?php if($type !='core') : ?>
						<li><a href="javascript://ajax" onclick="SximoConfirmDelete('<?php echo site_url('administrator/module/destroy/'.$row->module_id);?>')"><i class="fa fa-trash-o"></i><?php echo $this->lang->line('core.fr_removemodule'); ?> </a></li>
						<li class="divider"></li>
						<li><a href="<?php echo site_url('administrator/module/rebuild/'.$row->module_id);?>"><i class="fa fa-reload"></i><?php echo $this->lang->line('core.fr_rebuildmodule'); ?> </a></li>
						<?php endif;?>
					</ul>
				</div>					
				</td>
	...
	<?php else:?>
		...
		<br /><br />
		<a href="<?php echo site_url('administrator/module/create');?>" class="btn btn-default "><i class="icon-plus-circle2"></i><?php echo $this->lang->line('core.fr_newmodule'); ?> </a>
		 </p>	
	<?php endif;?>
	</div>	
