    ...
    <div class="page-content-wrapper m-t">
        <div class="toolbar-line ">		
            <?php if ($this->access['is_add'] == 1) : ?>
                <a href="<?php echo site_url('administrator/pageimage/add') ?>" class="tips btn btn-xs btn-info"  title="<?php echo $this->lang->line('core.btn_new'); ?>">
            ...
            if ($this->access['is_excel'] == 1) :
                ?>	
                <a href="<?php echo site_url('administrator/pageimage/download') ?>" class="tips btn btn-xs btn-default" title="<?php echo $this->lang->line('core.btn_download'); ?>">
                    <i class="fa fa-download"></i>&nbsp;<?php echo $this->lang->line('core.btn_download'); ?></a>
                <?php
            endif;
            if ($this->session->userdata('gid') == 1) :
                ?>	
                <a href="<?php echo site_url('administrator/module/config/pageimage') ?>" class="tips btn btn-xs btn-default"  title="<?php echo $this->lang->line('core.btn_config'); ?>">
                    <i class="fa fa-cog"></i>&nbsp;<?php echo $this->lang->line('core.btn_config'); ?></a>
            <?php endif; ?>		

        </div>
        <?php echo $this->session->flashdata('message'); ?>
        <form action='<?php echo site_url('administrator/pageimage/destroy') ?>' class='form-horizontal' id ='SximoTable' method="post" >
                    ...
                    <tbody>
                        ...
                        <tr >
                            ...
                            <tr>
                                ...
                                <td width="50"><input type="checkbox" class="ids" name="id[]" value="<?php echo $row->tb_page_image_id ?>" />  </td>
                                    ...
                                    <div class="btn-group">		
                                        ...
                                        <ul  class="dropdown-menu  icons-left pull-right">					 	
                                            ...
                                            <?php if ($access['is_detail'] == 1) : ?>
                                                <li><a href="<?php echo site_url('administrator/pageimage/show/' . $row->tb_page_image_id) ?>"  class="tips "  title="view"><i class="fa  fa-search"></i> <?php echo $this->lang->line('core.btn_view'); ?> </a></li>
                                                <?php
                                            endif;
                                            if ($access['is_edit'] == 1) :
                                                ?>
                                                <li><a  href="<?php echo site_url('administrator/pageimage/add/' . $row->tb_page_image_id) ?>"  class="tips "  title="edit"> <i class="fa fa-edit"></i>  <?php echo $this->lang->line('core.btn_edit'); ?> </a> </li>
                                                <?php endif; ?>
...
<script>
    $(document).ready(function () {
        ...
        $('.do-quick-search').click(function () {
            $('#SximoTable').attr('action', '<?php echo site_url("administrator/pageimage/multisearch"); ?>');
            $('#SximoTable').submit();
        });
