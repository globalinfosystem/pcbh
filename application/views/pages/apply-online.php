            ...
            <div class="col-md-8 col-xs-8 table-responsive">
                <table class="table table-bordered table-striped table-condensed table-responsive">
					...
					<tr>
						...
						<td colspan="2"><h4><legend>Applicant Details:</legend></h4></td>
					...
					<tr>
						...
						<td><input required="required" style="width:100%" type="text"  value="<?php echo!empty($row['applicant_organization']) ? $row['applicant_organization'] : ''; ?>" onkeyup="isAlphaKey1(this)" value="" maxlength="50" name="organization"  id="organization" class="form-control"><br /><div id="organization1" style="display:none; color:#FF0000;">Please Enter Organization</div></td>
						</tr>
						
						
						<tr>
						<th>Applicant Name:<font size="2" color="red">* </font></th>
						<td><input required="required" style="width:100%" type="text"  value="<?php echo!empty($row['applicant_name']) ? $row['applicant_name'] : ''; ?>" onkeyup="isAlphaKey1(this)" value="" maxlength="50" name="aname"  id="aname" class="form-control"><br /><div id="aname1" style="display:none; color:#FF0000;">Please Enter Applicant Name</div></td>
						</tr>
						
						<tr>
						<th>Father's Name:<font size="2" color="red">* </font></th>
						<td><input required="required" type="text" style="width:100%" value="<?php echo!empty($row['applicant_name']) ? $row['applicant_name'] : ''; ?>" onkeyup="isAlphaKey1(this)" value="" maxlength="50" name="fname"  id="fname" class="form-control"><br /><div id="fname1" style="display:none; color:#FF0000;">Please Enter Father Name</div></td>
						</tr>
						<tr>
						<th>Applicant's Address 1:<font size="2" color="red">*
                                                        </font></th>
						<td><textarea  required="required" style="width:100%" rows="5" cols="25" name="address"  id="address" class="form-control"><?php echo!empty($row['from_whom_reciv']) ? $row['from_whom_reciv'] : ''; ?></textarea><br /><div id="address1" style="display:none; color:#FF0000;">Please Enter Address</div></td>								
						</tr>
						
						<tr>
						<th>Applicant's Address 2:<font size="2" color="red">
                                                        </font></th>
                          <td><textarea  required="required" style="width:100%" rows="5" cols="25" name="address2" class="form-control"><?php echo!empty($row['from_whom_reciv']) ? $row['from_whom_reciv'] : ''; ?></textarea></td>                        
						</tr>
						
						<tr>
						<th>State:</th>
						<td>
                                                        <select style="width:100%" required="required" style="width:170px" id="state" name="state" class="form-control select2">
						...
						<th>District:</th>
						<td>
                                                        <select style="width:100%" required="required" style="width:170px" id="district" name="district" class="form-control select2">
															<?php
						...
						<tr>
						<th>E-mail:</th>
						<td><input style="width:100%" required="required" type="email" value="<?php echo!empty($row['application_email']) ? $row['application_email'] : ''; ?>" name="email" id="email"  class="form-control"><br /><div id="email1" style="display:none; color:#FF0000;">Please Enter Email</div></td>
						</tr>
						<tr>
						<th>Mobile:(+91)</th>
						<td>
 <input type="text" style="width:100%" onkeypress="return isNumberKey(event)" onkeyup="checkzero(this)" value="<?php echo!empty($row['applicant_mobile']) ? $row['applicant_mobile'] : ''; ?>" maxlength="10" name="mobile"  id="mobile" class="form-control"><br /><div id="mobile1" style="display:none; color:#FF0000;">Please Enter Mobile No.</div></td>
