...
<script type="text/javascript" src="<?php echo base_url() ?>design/datepicker/date.js"></script>
<script type="text/javascript" src="<?php echo base_url() ?>design/datepicker/datePicker2.js"></script>
<link href="<?php echo base_url() ?>design/datepicker/datePicker2.css" type="text/css" rel='stylesheet' />
						...
						<select name="commissioner" class="form-control">
							...
							<?php if(!empty($commissioner)) { ?> 
								<?php foreach($commissioner as $commissionerKey => $commissionerArray){ ?> 
									<option value="<?php echo $commissionerKey;?>"><?php echo $commissionerArray['bench_id'];?>-<?php echo $commissionerArray['emp_name'];?></option>
								<?php } ?>
							<?php } ?>
						</select>
                    </div>
