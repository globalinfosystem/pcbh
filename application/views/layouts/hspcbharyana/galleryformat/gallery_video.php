<?php $galleriesImage = SiteHelpers::getGalleryVideos($gallery_id); ?>
<?php $galleries = SiteHelpers::getGallery('video'); ?>
<style>
    ul {         
        padding:0 0 0 0;
        margin:0 0 0 0;
                ...
                <div class="table-responsive"> 
                    <ul class="row">
                        <?php foreach ($value as $keySub => $valueSub) { ?>
                            <li class="col-sm-3">
                                <img class="img-responsive" src="<?php echo base_url() . 'uploads/galleryVideos/' . $valueSub['gallary_image_path']; ?>" alt="<?php echo $valueSub['gallary_image_title']; ?>">
                            </li>
                        <?php } ?>
                    </ul>
                </div>
