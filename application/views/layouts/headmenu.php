        ...
        <ul class="nav navbar-top-links navbar-right">
            ...
            <?php if ($this->session->userdata('gid') == 1) : ?>
                ...
                <li class="user dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right icons-right">
                        <li><a href="<?php echo site_url('administrator/config'); ?>"><i class="fa  fa-wrench"></i> <?php echo $this->lang->line('core.m_setting'); ?> </a></li>
<!--                        <li><a href="<?php echo site_url('users'); ?>" ><i class="fa fa-user"></i> <?php echo $this->lang->line('core.m_usersgroups'); ?> </a></li>-->
<!--                        <li><a href="<?php echo site_url('administrator/config/blast'); ?>"><i class="fa fa-envelope"></i> <?php echo $this->lang->line('core.m_blastemail'); ?> </a></li>-->
<!--                        <li><a href="<?php echo site_url('logs'); ?>"><i class="fa fa-clock-o"></i> <?php echo $this->lang->line('core.m_logs'); ?> </a></li>-->
                        <li class="divider"></li>
                        <li><a href="<?php echo site_url('administrator/pages'); ?>"><i class="fa  fa-copy"></i> <?php echo $this->lang->line('core.m_pagecms'); ?> </a></li>
                        <li><a href="<?php echo site_url('administrator/menu'); ?>" ><i class="fa fa-sitemap"></i> <?php echo $this->lang->line('core.m_menu'); ?> </a></li>		
                        <!--<li class="divider"></li>
                        <li><a href="<?php echo site_url('administrator/module'); ?>" ><i class="fa fa-cogs"></i> <?php echo $this->lang->line('core.m_codebuilder'); ?> </a></li>-->
                    </ul>
                </li>	
