        ...
        <ul id="sidemenu" class="nav expanded-menu">
            <li class="logo-header" >
                <a class="navbar-brand" href="<?php echo site_url('dashboard'); ?>">
                    <img width="30" align="middle" style="margin-right:5px;" alt="My Apps" src="<?php echo base_url(); ?>design/images/logo.png">
            ...
            <li class="nav-header">
                <div class="dropdown profile-element" style="text-align:center;"> 
                    <span>
                            <img width="30" align="middle" style="margin-right:5px;" alt="Logout" src="<?php echo base_url(); ?>design/images/logout-icon.png">
            ...
            <?php foreach ($sidebar as $menu) : ?>
                <li>
                    ...
                    if ($menu['menu_type'] == 'external') {
                        ...
                        echo 'href="' . site_url('administrator/'.$menu['module']) . '"';
                    }
                    ?>	
                            ...
                            <?php foreach ($menu['childs'] as $menu2) : ?>
                                <li>
                                    ...
                                    if ($menu2['menu_type'] == 'external') {
                                        ...
                                        echo 'href="' . site_url('administrator/'.$menu2['module']) . '"';
                                    }
                                    ?>									
                                            ...
                                            <?php foreach ($menu2['childs'] as $menu3) : ?>
                                                <li>
                                                    ...
                                                    if ($menu3['menu_type'] == 'external') {
                                                        ...
                                                        echo 'href="' . site_url('administrator/'.$menu3['module']) . '"';
                                                    }
                                                    ?>																
