...
<!--			<div class="col-sm-6 col-md-3 b-r  p-sm ">
			...
			<div class="col-sm-6 col-md-3 b-r  p-sm">
				...
				<a href="<?php echo site_url('administrator/config');?>" class="clear">
			...
			<div class="col-sm-6 col-md-3 b-r  p-sm">
				...
				<a href="<?php echo site_url('administrator/menu');?>" class="clear">
...
<script src="<?php echo base_url();?>design/js/plugins/chartjs/Chart.min.js"></script>
<script>
